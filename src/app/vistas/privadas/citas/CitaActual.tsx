...
export const CitaActual = () => {
  ...
  const obtenerMedicos = async () => {
    const urlMedicos = ApiBack.USUARIOS_OBTENER + "/6373b2f202c91caf434a171a";
...
// *******************************************************************
  ...
  const enviarFormulario = async (fh: formaHtml) => {
    ...
    if (formulario.checkValidity() === false) {
      ...
      console.log(objeto);
      const resultado = await ServicioPrivado.peticionPUT( ApiBack.CITAS_ACTUALIZAR, objeto );

      if (resultado.id) {
        setEnProceso(false);
        MensajeToastify("success", "Cita actualizada con éxito", 7000);
      } else {
      ...
      <div className="pagetitle">
        ...
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Modificar Citas</li>
          </ol>
        </nav>
      </div>
        ...
        {cargaFinalizada ? (
          <div className="card">
            <div className="card-body">
              <h5 className="card-title">Formulario de Modificacion</h5>
